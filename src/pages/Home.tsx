...
const Home = () => {
  ...
  // Initialize canvas cursor effect only on desktop
  useEffect(() => {
  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      >
        {/* Canvas cursor effect - desktop only */}
        <canvas
          className="pointer-events-none absolute inset-0 mx-auto z-0 hidden md:block"
          id="canvas"
        ></canvas>
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-20">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <div className="mb-8">
              <ParticleTextEffect 
                words={["HELLO", "I'M", "MOKSHAGNA", "ANURAG", "KANKATI"]}
                className="mx-auto"
                canvasWidth={800}
                canvasHeight={150}
                theme={theme}
