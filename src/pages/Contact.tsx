    ...
    <div className="relative min-h-screen px-4 py-16 bg-background text-foreground transition-colors duration-300 overflow-hidden pt-24">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105 active:scale-95"
          >
            Send Message
          </button>
          {status && (
