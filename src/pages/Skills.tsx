        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSkills.map((skill, index) => (
              <AnimatedBorder
                key={skill.name}
                className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/20 dark:border-gray-800/50 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-500"
                speed={0.15}
                colors={{
                  primary: "rgb(59 130 246 / 0.25)",
                  secondary: "rgb(168 85 247 / 0.25)"
                }}
              >
                <SkillCard 
                  skill={skill} 
