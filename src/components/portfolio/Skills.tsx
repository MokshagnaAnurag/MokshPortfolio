...
const groups = [
  ...
  {
    title: "Robotics Simulation & Physical AI",
    items: [
      "NVIDIA Isaac Sim",
      "Webots",
      "MuJoCo",
...
const achievements = [
...

  {
    ...
    detail:
      "Advanced to finals for a cybersecurity-driven IoT prototype.",
  },
];
...
export function Skills() {
  return (
    <>
      ...
      {/* ========================================================= */}
      {/* 3. HONORS & CERTIFICATIONS SECTION */}
      {/* ========================================================= */}
                  ...
                  {achievements.map((a, i) => (
                    ...
                    >
                      ...
                      <div className="shrink-0 mt-2 md:mt-0">
                        <span className="font-mono text-[0.6rem] font-bold uppercase px-2 py-1 border border-[var(--color-industrial-dark)] text-[var(--color-industrial-white)] bg-[var(--color-industrial-dark)] group-hover:bg-[var(--color-industrial-blue)] group-hover:border-[var(--color-industrial-blue)] transition-colors inline-block">
                          {a.host}
                        </span>
                      </div>
                    </div>
