  ...
  return (
    <section id="education" className="relative py-24 bg-black border-b-[8px] border-zinc-900 overflow-hidden font-sans">
      ...
      <div className="mx-auto max-w-[1200px] px-6 relative z-10">
        ...
        {/* Realistic Student ID Cards Layout */}
              ...
              <Reveal key={it.institution} delay={i * 0.1}>
                ...
                <div className="group relative w-[360px] bg-white rounded-lg shadow-[10px_10px_0_#3b82f6] border-[3px] border-zinc-800 overflow-hidden transition-transform duration-300 hover:-translate-y-2 hover:shadow-[15px_15px_0_#ef4444] flex flex-col">
                  ...
                  <div className="w-full bg-blue-900 text-white flex justify-between items-center px-4 py-2 border-b-[3px] border-black relative">
                    ...
                    <span className="font-display font-black text-sm uppercase tracking-widest mt-1">
                      STUDENT ID
                    </span>
                    <span className="font-mono text-[0.6rem] uppercase tracking-widest text-blue-200">
                      {it.period}
                    </span>
                  </div>
                  ...
                  <div className="flex p-4 gap-4 bg-yellow-50 bg-opacity-30 relative">
                    ...
                    <div className="w-24 flex flex-col items-center gap-2">
                      ...
                      <div className="font-mono text-[0.55rem] font-bold text-center w-full uppercase break-words leading-tight mt-1 text-zinc-600">
                        ID: {it.idNo}
                      </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col pt-1">
                      <h3 className="font-display text-lg font-black uppercase text-black leading-tight mb-2">
                        {it.institution}
                      </h3>
                  ...
                  <div className="w-full h-5 bg-white border-t-[3px] border-black flex items-center justify-center overflow-hidden">
                    <div
                      ...
                      style={{ backgroundImage: "repeating-linear-gradient(to right, #000 0, #000 2px, transparent 2px, transparent 4px, #000 4px, #000 6px, transparent 6px, transparent 7px)" }}
                    ></div>
                  </div>
