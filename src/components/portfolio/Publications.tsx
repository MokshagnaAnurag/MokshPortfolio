            ...
            <Reveal key={pub.doi} delay={i * 0.05}>
              ...
              >
                ...
                <div className="col-span-12 font-mono text-[11px] uppercase tracking-[0.28em] text-muted-foreground md:col-span-3">
                  ...
                  <span className="mt-2 block text-muted-foreground/50">
                    {pub.journal}
                  </span>
                </div>

                {/* Title & Abstract */}
                <div className="col-span-12 pr-4 md:col-span-7">
                  ...
                  <p className="mt-3 font-mono text-[11px] text-accent-violet break-all">
                    DOI: {pub.doi}
                  </p>
                ...
                {/* Icon */}
                <div className="col-span-12 flex justify-start text-muted-foreground/40 transition-colors group-hover:text-foreground md:col-span-2 md:justify-end">
