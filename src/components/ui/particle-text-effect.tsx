...
const DEFAULT_WORDS = ["HELLO", "I'M", "MOKSHAGNA", "ANURAG", "KANKATI"]
...
export function ParticleTextEffect({ 
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    offscreenCtx.font = `bold ${Math.min(canvas.width / 8, 60)}px Arial`
    ...
    // Generate new color with blue/purple gradient
    const colors = [
      { r: 58, g: 94, b: 255 },   // #3A5EFF
      { r: 170, g: 94, b: 255 },  // #AA5EFF
  ...
  const animate = () => {
    ...
    // Auto-advance words with throttling
